        ...
        <form className="clientForm" onSubmit={handleSubmit}>
          <fieldset className="gridThis">
            ...
            <div className="form-group first">
              <label className="client-label" htmlFor="firstName">
                first name:{" "}
              </label>
              <input
                type="text"
            ...
            <div className="form-group last">
              <label className="client-label" htmlFor="lastName">
                last name:{" "}
              </label>
              <input
                type="text"
            ...
            <div className="form-group email">
              <label className="client-label" htmlFor="clientEmail">
                email:{" "}
              </label>
              <input
                ref={email}
            ...
            <div className="form-group phone">
              <label className="client-label" htmlFor="clientPhone">
                phone:{" "}
              </label>
              <input
                type="number"
